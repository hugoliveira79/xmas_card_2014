...
<!-- <meta property="og:url" content="http://www.google.pt" /> -->
            ...
            <div class="container" style="width:100%;padding: 0 0px 0 20px;">
                ...
                <div class="navbar-collapse collapse " align="center">
                    <ul class="nav navbar-nav" align="center">
                        <li  style="height:70px;width:150px;border-left: 1px solid #3F3F3F;border-left-width: thin;margin-left: auto; margin-right: auto;" align="center"><a href="index.php" style="color:#FFFFFF;margin-left:0px">H<span style="text-transform:lowercase;">ome</span></a></li>
                        <li  style="height:70px;width:150px;border-left: 1px solid #3F3F3F;border-left-width: thin;margin-left: auto; margin-right: auto;" align="center"><a href="criarpostal.php" style="color:#FFFFFF;margin-left:0px">C<span style="text-transform:lowercase;">riar Postal</span></a></li>
                        <li class="active"  align="center" style="height:70px;width:150px;border-bottom: thick solid #3a4d98;border-left: 1px solid #3F3F3F;border-left-width: thin;margin-left: auto; margin-right: auto;"><a href="galeria.php" style="color:#FFFFFF;margin-left:0px">G<span style="text-transform:lowercase;">aleria</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row" id="partilha">
                <div class="col-md-3 col-md-3 col-md-offset-3" style="position: relative;">  
                    ...
                    <span onClick="hideElement('faca_postal_btn',true);hideElement('email_form',false);" ><img src="img/share/mail.png"></span>
                ...
                <div class=" col-md-3 col-md-3" id="faca_postal_btn" style="position: relative;">  
                    <button type="button" class="btn btn-default" style="border-style: solid;border-color: #e20011;height:65px" aria-label="Left Align" onClick="location.href='index.php'">
                        <span style="font-family: frutigerltstd-light-webfont;font-size:12pt;color:#e20011;">Faça o seu postal</span>
                        <span class="glyphicon glyphicon-play-circle" id="seguinte" aria-hidden="true" style="color:#e20011;"></span>                           
                    </button>
                </div>
                <div class=" col-md-3 col-md-4" style="position: relative;">  
